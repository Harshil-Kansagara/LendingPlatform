...
namespace LendingPlatform.DomainModel.Migrations
{
    ...
    [Migration("20210204072859_11_AddOrderColumnInTaxFormLabelNameMapping")]
    partial class _11_AddOrderColumnInTaxFormLabelNameMapping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.EntityInfo.DocumentExtractedValueSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("LoanApplicationSnapshotId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LoanApplicationSnapshotId");

                    b.HasIndex("UpdatedByBankUserId");

                    b.ToTable("DocumentExtractedValueSnapshot");
                });
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.LoanApplicationInfo.ProductPurposeMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ProductPurposeMapping");
                });
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.EntityInfo.DocumentExtractedValueSnapshot", b =>
                {
                    ...
                    b.HasOne("LendingPlatform.DomainModel.Models.EntityInfo.Document", "Document")
                        .WithOne("DocumentExtractedValueSnapshot")
                        .HasForeignKey("LendingPlatform.DomainModel.Models.EntityInfo.DocumentExtractedValueSnapshot", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LendingPlatform.DomainModel.Models.LoanApplicationInfo.LoanApplicationSnapshot", "LoanApplicationSnapshot")
                        .WithMany()
                        .HasForeignKey("LoanApplicationSnapshotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.EntityInfo.EntityFinance", b =>
                {
                    ...
                    b.HasOne("LendingPlatform.DomainModel.Models.LoanApplicationInfo.LoanApplication", null)
                        .WithMany("EntityFinances")
