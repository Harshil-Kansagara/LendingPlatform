...
namespace LendingPlatform.DomainModel.Migrations
{
    ...
    [Migration("20210104111818_2_AddThirdPartyWiseCompanyNameFieldInEntityFinances")]
    partial class _2_AddThirdPartyWiseCompanyNameFieldInEntityFinances
    {
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.LoanApplicationInfo.LoanApplication", b =>
                {
                    ...
                    b.Property<Guid?>("StatusUpdatedByBankUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StatusUpdatedByBankUserId");
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.EntityInfo.CreditReport", b =>
                {
                    b.HasOne("LendingPlatform.DomainModel.Models.EntityInfo.Entity", "Entity")
                        ...
                        .HasForeignKey("LendingPlatform.DomainModel.Models.EntityInfo.CreditReport", "EntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LendingPlatform.DomainModel.Models.LoanApplicationInfo.LoanApplication", b =>
                {
                    ...
                    b.HasOne("LendingPlatform.DomainModel.Models.BankUser", "StatusUpdatedByBankUser")
                        .WithMany()
                        .HasForeignKey("StatusUpdatedByBankUserId");
